...
/*
	suggestSearchTerms :: string x string x string -> string
...
const suggestSearchTerms = function (rawQuery, searchTerms, suggestions) {
...
const giveSuggestions = function (browserResponse, redirected) {
	...
	request(redirected.suggestionURL, function (err, res, body) {
		...
		if (err) {
			...
			.send(suggestSearchTerms(redirected.rawQuery, redirected.searchTerms, body))
			.end()
