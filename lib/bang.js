...
const debugInfo = utils.debugInfo
...
const redirectBrowser = function (res, redirected, callback) {
...
const BangServer = function (services, config) {
	...
	app.get('/search', function (req, res) {
		...
		requestedHelp ?
			serveHelp(res) :
			redirectBrowser(res, redirected, callServices)

	})

	app.use(function (err, _, _, _) {

		logger.error(err.stack, debugInfo())
