...
const exclaim = {
	startup: function (port) {
		...
		console.log(
			'bang! js server listening at http://localhost:' + port + '/' + '\n' +
...
server.on("error", function (err) {
	console.log("An error was thrown by the Bang! server executing on port " + constants.port + ":\n" )
	console.dir(err)
})

server.listen(constants.port)

exclaim.startup(constants.port)
