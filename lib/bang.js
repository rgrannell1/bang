...
const BangServer = function (services) {
	...
	return app.listen(constants.port, function () {
		logger.info('Bang! %d listening at http://localhost:%d (pid %d).', constants.version, constants.port, process.pid)
	})
