...
/*
	processSuggestions :: string x string x string -> string
...
const processSuggestions = function (rawQuery, searchTerms, body) {
...
const giveSuggestions = function (browserResponse, redirected) {
	...
	request(redirected.suggestionURL, function (err, res, body) {
		...
		if (err) {
			...
			.send(processSuggestions(redirected.rawQuery, redirected.searchTerms, body))
			.end()
